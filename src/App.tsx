    ...
    <>
      ...
      <div className="list-horizontally">
        ...
        <a href='https://discord.gg/npRxWfkqdv' target="_blank" rel="noopener noreferrer">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" className='social-icon'>
            {/* !Font Awesome Free v7.1.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc. */}
      ...
      <div className="card">
        <iframe src="https://calendar.google.com/calendar/embed?height=600&wkst=1&ctz=America%2FSt_Johns&showPrint=0&mode=AGENDA&showTabs=0&showCalendars=0&title=Upcoming%20NFJ%20Events&src=nlfightingjam%40gmail.com&color=%230b8043" width="800" height="600" frameBorder="0" scrolling="no"></iframe>
      </div>
    </>
  )
}
